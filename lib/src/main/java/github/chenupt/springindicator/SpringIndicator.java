...
public class SpringIndicator extends FrameLayout {
    ...
    private int selectedImageDrawableId;
    ...
    private void initAttrs(AttributeSet attrs){
        ...
        selectedImageDrawableId = a.getResourceId(R.styleable.SpringIndicator_siSelectedImageDrawable, selectedImageDrawableId);
    ...
    private void addImageTabItems(@NonNull ImageView[] images) {
        ...
        for (int i = 0; i < viewPager.getAdapter().getCount(); i++) {
            ...
            if (textBgResId != 0){
                image.setImageResource(textBgResId);
            }
